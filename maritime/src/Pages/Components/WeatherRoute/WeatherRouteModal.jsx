      ...
      <div className="modal-dialog modal-xl modal-dialog-scrollable modal-fullscreen-md-down">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title title-text">Weather for next 7 days</h5>
            <button
              type="button"
              className="btn-close"
              onClick={handleClose}
                  ...
                  <div className="col-lg-4 col-md-6 col-12">
                    ...
                    <div className="left-side">
                      <p>
                        ...
                        {selectedWeather.maxtempC}°C ({selectedWeather.maxtempF}
                        °F)
                      </p>
                      <p>
                        <strong>Min Temperature:</strong>{" "}
                        {selectedWeather.mintempC}°C ({selectedWeather.mintempF}
                        °F)
                      </p>
                      <p>
                      ...
                      {selectedHour && (
                        <div className="hour-details">
                          ...
                          <div className="right-column">
                            ...
                            <p>
                              Swell Period: {selectedHour.swellPeriod_secs} secs
                            </p>
                          </div>
                        </div>
                      )}
